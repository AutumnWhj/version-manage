...
var handleVersionTag = function (config) {
    ...
    return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_d) {
            switch (_d.label) {
                case 0:
                    log(source(templateObject_1 || (templateObject_1 = __makeTemplateObject(["{green \uD83C\uDFF7  Tag\u57FA\u7EBF: \u6839\u636Epackage.json\u6587\u4EF6\u7684version\u751F\u6210\u5E76\u66F4\u65B0}"], ["{green \uD83C\uDFF7  Tag\u57FA\u7EBF: \u6839\u636Epackage.json\u6587\u4EF6\u7684version\u751F\u6210\u5E76\u66F4\u65B0}"]))));
                    _b = (_a = console).log;
                    _c = [".branchLocal(): "];
                        ...
                        return __awaiter(void 0, void 0, void 0, function () {
                            ...
                            return __generator(this, function (_b) {
                                switch (_b.label) {
                                    case 0:
                                        _b.trys.push([0, 5, , 6]);
                                        if (!(baseline === "package")) return [3 /*break*/, 1];
                                        return [3 /*break*/, 4];
                                    case 1: return [4 /*yield*/, inquirerInputTag()];
                                    case 2:
                                        inputTag = _b.sent();
        ...
        return __generator(this, function (_b) {
            switch (_b.label) {
                ...
                case 3:
                    ...
                    log(source(templateObject_2 || (templateObject_2 = __makeTemplateObject(["{gray \u2795  \u6682\u5B58package.json\u6587\u4EF6\u53D8\u66F4}"], ["{gray \u2795  \u6682\u5B58package.json\u6587\u4EF6\u53D8\u66F4}"]))));
                    return [4 /*yield*/, git.add("./package.json")];
                case 4:
                    _b.sent();
                    log(source(templateObject_3 || (templateObject_3 = __makeTemplateObject(["{gray \u2714\uFE0F  \u63D0\u4EA4package.json\u6587\u4EF6\u53D8\u66F4}"], ["{gray \u2714\uFE0F  \u63D0\u4EA4package.json\u6587\u4EF6\u53D8\u66F4}"]))));
                    return [4 /*yield*/, git.commit("chore: release version " + version + " in " + date + " by " + tag)];
                case 5:
                    _b.sent();
                    log(source(templateObject_4 || (templateObject_4 = __makeTemplateObject(["{green \uD83D\uDC4C  package.json\u6587\u4EF6\u64CD\u4F5C\u5B8C\u6210}"], ["{green \uD83D\uDC4C  package.json\u6587\u4EF6\u64CD\u4F5C\u5B8C\u6210}"]))));
                ...
                case 7:
                    error_1 = _b.sent();
                    e = error_1;
                    log(source(templateObject_5 || (templateObject_5 = __makeTemplateObject(["{red ", "}"], ["{red ", "}"])), e.message));
                    return [3 /*break*/, 8];
...
function createTag(tag) {
    return __awaiter(this, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    log(source(templateObject_6 || (templateObject_6 = __makeTemplateObject(["{green \uD83D\uDD00  \u66F4\u65B0\u672C\u5730\u4ED3\u5E93}"], ["{green \uD83D\uDD00  \u66F4\u65B0\u672C\u5730\u4ED3\u5E93}"]))));
                    return [4 /*yield*/, git.pull({ "--rebase": "true" })];
                case 1:
                    _a.sent();
                    log(source(templateObject_7 || (templateObject_7 = __makeTemplateObject(["{green \uD83C\uDFF7  \u521B\u5EFA\u6807\u7B7E ", "}"], ["{green \uD83C\uDFF7  \u521B\u5EFA\u6807\u7B7E ", "}"])), tag));
                ...
                case 3:
                    _a.sent();
                    log(source(templateObject_8 || (templateObject_8 = __makeTemplateObject(["{green \uD83C\uDFF7  push\u6807\u7B7E ", "\u6210\u529F}"], ["{green \uD83C\uDFF7  push\u6807\u7B7E ", "\u6210\u529F}"])), tag));
                    return [2 /*return*/];
            }
        });
    });
                                ...
                                return __generator(this, function (_b) {
                                    switch (_b.label) {
                                        case 0:
                                            ...
                                            log(source(templateObject_9 || (templateObject_9 = __makeTemplateObject(["{gray \uD83D\uDE80  \u6B63\u5728\u81EA\u52A8\u63D0\u4EA4\u6587\u4EF6}"], ["{gray \uD83D\uDE80  \u6B63\u5728\u81EA\u52A8\u63D0\u4EA4\u6587\u4EF6}"]))));
...
var getReleaseEnv = function (env) {
    if (env.includes("release")) {
        var lastCharIndex = env.lastIndexOf("/");
