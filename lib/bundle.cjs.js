...
var checkPackage = function (pack) {
    return new Promise(function (resolve, reject) {
        fs__default["default"].exists(path__default["default"].resolve(process.cwd() + "/node_modules/" + pack + "/"), function (exists) {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, Promise.all([
                        ...
                        checkPackage("semver"),
                    ]).then(function () { return handleVersionTag(config); })];
                case 1:
                    _a.sent();
                    return [2 /*return*/];
            }
