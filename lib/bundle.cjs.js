...
var getPackage = function () {
    (function (t) { return Promise.resolve().then(function () { return /*#__PURE__*/_interopNamespace(require(t)); }); })(getPackageJsonPath());
};
/**
 * 格式化时间
 *
...
var handleVersionTag = function () { return __awaiter(void 0, void 0, void 0, function () {
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                ...
                return [4 /*yield*/, addTagByPackage()];
            case 1:
                _a.sent();
                return [2 /*return*/];
        }
...
function addTagByPackage() {
    return __awaiter(this, void 0, void 0, function () {
        var packageJson, branch, config, _a, version, tag, date, error_1, e;
        return __generator(this, function (_b) {
            switch (_b.label) {
                ...
                case 1:
                    _b.sent();
                    return [4 /*yield*/, getPackage()];
                case 2:
                    packageJson = _b.sent();
                    log("packageJson", packageJson);
                    branch = "getLocalBranch()";
                    return [4 /*yield*/, generateNewTag(branch, packageJson.version)];
                case 3:
                    config = _b.sent();
                    _a = config || {}, version = _a.version, tag = _a.tag;
            ...
            switch (_a.label) {
                ...
                case 1:
                    ...
                    return [4 /*yield*/, inquirer
                            ...
                            .then(function (_a) {
                            var commit = _a.commit; _a.env;
                            return __awaiter(_this, void 0, void 0, function () {
                                return __generator(this, function (_b) {
                                    switch (_b.label) {
                                        case 0:
                                            _b.trys.push([0, 5, , 6]);
                                            if (!(commit === "yes")) return [3 /*break*/, 3];
 ...
 * @param {*} version
 */
var generateNewTag = function (env, version) {
    if (env === void 0) { env = "master"; }
    if (version === void 0) { version = "0.0.0"; }
    return __awaiter(void 0, void 0, void 0, function () {
        var date, minor, patch, config, currentEnv;
        return __generator(this, function (_a) {
            date = formatTime(new Date(), "{yy}-{mm}-{dd}");
            minor = semver.minor(version);
            patch = semver.patch(version);
            config = { env: env, version: version, tag: env + "-v" + version + "-" + date };
            if (patch >= 99) {
