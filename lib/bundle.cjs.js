                        ...
                        return __generator(this, function (_a) {
                            switch (_a.label) {
                                case 0:
                                    ...
                                    log(source(templateObject_1 || (templateObject_1 = __makeTemplateObject(["{gray \uD83C\uDFF7  \u4ED3\u5E93\u6700\u65B0\u7684Tag: ", "}"], ["{gray \uD83C\uDFF7  \u4ED3\u5E93\u6700\u65B0\u7684Tag: ", "}"])), lastTag));
                                    lastVsersion = lastTag.split("-")[1].substring(1);
                                    return [4 /*yield*/, generateNewTag(envName, lastVsersion)];
                                case 1:
                                    version = _a.sent();
                                    log(source(templateObject_2 || (templateObject_2 = __makeTemplateObject(["{gray \uD83C\uDFF7  \u751F\u6210\u6700\u65B0\u7684Tag: ", "}"], ["{gray \uD83C\uDFF7  \u751F\u6210\u6700\u65B0\u7684Tag: ", "}"])), version.tag));
            ...
            switch (_a.label) {
                ...
                case 1:
                    ...
                    versions.forEach(function (_a) {
                        ...
                        log(source(templateObject_3 || (templateObject_3 = __makeTemplateObject(["{green \uD83D\uDCE6  package.json \u6587\u4EF6\u6DFB\u52A0\u5C5E\u6027 => ", ": ", "}"], ["{green \uD83D\uDCE6  package.json \u6587\u4EF6\u6DFB\u52A0\u5C5E\u6027 => ", ": ", "}"])), envConfig[env], version));
                    ...
                    log(source(templateObject_4 || (templateObject_4 = __makeTemplateObject(["{gray \u2795  \u6682\u5B58package.json\u6587\u4EF6\u53D8\u66F4}"], ["{gray \u2795  \u6682\u5B58package.json\u6587\u4EF6\u53D8\u66F4}"]))));
                    return [4 /*yield*/, git.add("./package.json")];
                case 2:
                    _a.sent();
                    log(source(templateObject_5 || (templateObject_5 = __makeTemplateObject(["{gray \u2714\uFE0F  \u63D0\u4EA4package.json\u6587\u4EF6\u53D8\u66F4}"], ["{gray \u2714\uFE0F  \u63D0\u4EA4package.json\u6587\u4EF6\u53D8\u66F4}"]))));
                    return [4 /*yield*/, git.commit("Relase version " + version + " in " + date + " by " + newTagsStr)];
                case 3:
                    _a.sent();
                    log(source(templateObject_6 || (templateObject_6 = __makeTemplateObject(["{green \uD83D\uDC4C  package.json\u6587\u4EF6\u64CD\u4F5C\u5B8C\u6210}"], ["{green \uD83D\uDC4C  package.json\u6587\u4EF6\u64CD\u4F5C\u5B8C\u6210}"]))));
                    // #endregion
                    return [4 /*yield*/, commitAllFiles()];
                case 4:
                    // #endregion
                ...
                case 6:
                    error_1 = _a.sent();
                    e = error_1;
                    log(source(templateObject_7 || (templateObject_7 = __makeTemplateObject(["{red ", "}"], ["{red ", "}"])), e.message));
                    return [3 /*break*/, 7];
                case 7: return [2 /*return*/];
            }
        });
...
function createTag(versions) {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    log(source(templateObject_8 || (templateObject_8 = __makeTemplateObject(["{green \uD83D\uDD00  \u66F4\u65B0\u672C\u5730\u4ED3\u5E93}"], ["{green \uD83D\uDD00  \u66F4\u65B0\u672C\u5730\u4ED3\u5E93}"]))));
                    return [4 /*yield*/, git.pull({ "--rebase": "true" })];
                case 1:
                    _a.sent();
                    versions.forEach(function (version) { return __awaiter(_this, void 0, void 0, function () {
                        return __generator(this, function (_a) {
                            switch (_a.label) {
                                case 0:
                                    log(source(templateObject_9 || (templateObject_9 = __makeTemplateObject(["{green \uD83C\uDFF7  \u521B\u5EFA\u6807\u7B7E ", "}"], ["{green \uD83C\uDFF7  \u521B\u5EFA\u6807\u7B7E ", "}"])), version.tag));
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    ...
                    log(source(templateObject_10 || (templateObject_10 = __makeTemplateObject(["{red \uD83D\uDEA8  \u6709\u672A\u63D0\u4EA4\u7684\u6587\u4EF6\u53D8\u66F4}"], ["{red \uD83D\uDEA8  \u6709\u672A\u63D0\u4EA4\u7684\u6587\u4EF6\u53D8\u66F4}"]))));
                    log(source(templateObject_11 || (templateObject_11 = __makeTemplateObject(["{gray \u2795  \u6682\u5B58\u672A\u63D0\u4EA4\u7684\u6587\u4EF6\u53D8\u66F4}"], ["{gray \u2795  \u6682\u5B58\u672A\u63D0\u4EA4\u7684\u6587\u4EF6\u53D8\u66F4}"]))));
                    return [4 /*yield*/, git.add("./*")];
                case 2:
                    _a.sent();
                    log(source(templateObject_12 || (templateObject_12 = __makeTemplateObject(["{gray \u2714\uFE0F  \u63D0\u4EA4\u672A\u63D0\u4EA4\u7684\u6587\u4EF6\u53D8\u66F4}"], ["{gray \u2714\uFE0F  \u63D0\u4EA4\u672A\u63D0\u4EA4\u7684\u6587\u4EF6\u53D8\u66F4}"]))));
