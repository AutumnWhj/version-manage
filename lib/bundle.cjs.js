...
var checkFileExists = function (files) {
    files.forEach(function (name) {
        ...
        if (!fs__default["default"].existsSync(name)) {
            log$1(source(templateObject_1$1 || (templateObject_1$1 = __makeTemplateObject(["{red  \uD83D\uDEA8 ", "\u6587\u4EF6\u4E0D\u5B58\u5728\uFF0C \u8BF7\u91CD\u8BD5}"], ["{red  \uD83D\uDEA8 ", "\u6587\u4EF6\u4E0D\u5B58\u5728\uFF0C \u8BF7\u91CD\u8BD5}"])), filePath));
            process.exit(1);
        }
    });
};
...
var createNewFile = function () { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 1:
                branch = _a.sent();
                if (!(branch && branch.startsWith('release/'))) return [3 /*break*/, 3];
            ...
            case 4:
                ...
                log(source(templateObject_11 || (templateObject_11 = __makeTemplateObject(["{red  \uD83D\uDEA8  \u521B\u5EFA\u6587\u4EF6\u5931\u8D25\uFF0C\u8BF7\u91CD\u8BD5}"], ["{red  \uD83D\uDEA8  \u521B\u5EFA\u6587\u4EF6\u5931\u8D25\uFF0C\u8BF7\u91CD\u8BD5}"]))));
                return [3 /*break*/, 5];
